...
test("GET_stellar_system_should_return_200", async () => {
    const response = await fetch(
        "http://localhost:3000/api/v1/stellar-systems/",
        {
            headers: {
    ...
    expect(responseBody.data.stellar_systems.length).toEqual(
        responseBody.data.count_stellar_systems,
    );
});
...
test("GET_stellar_systems_with_id_should_return_200", async () => {
    const response = await fetch(
        "http://localhost:3000/api/v1/stellar-systems/1",
        {
            headers: {
                "Content-Type": "application/json",
            },
...
test("GET_invalid_stellar_system_should_return_404", async () => {
    const response = await fetch(
        "http://localhost:3000/api/v1/stellar-systems/99",
        {
            headers: {
                "Content-Type": "application/json",
            },
